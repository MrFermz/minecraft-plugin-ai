...
|-----------------|-------------|---------|-----|
| [`minecraft-plugin-core`](minecraft-plugin-core/) | `Core` | shared API/library — HikariCP pool เดียว, web-config client, service API, `EcosystemData`, `PluginLog` (load เป็น plugin แยกบน server) | เป็นเจ้าของ pool |
